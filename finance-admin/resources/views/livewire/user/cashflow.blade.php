                                ...
                                <div class="table-container">
                                    <table class="table">
                                        ...
                                        @foreach ($cashflow as $item)
                                            <tbody wire:key="{{ $item->cashflow_code }}">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <ul class="action">
                                                            <li class="edit"> <a
                                                                    wire:click="edit({{ $item->cashflow_code }})"><i
                                                                        class="icon-pencil-alt"></i></a>
                                                            </li>
                                                            <li class="delete"><a
                                                                    wire:click="delete({{ $item->cashflow_code }})"><i
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            <x-date label="Date" name="cashflow_date" wire:model="cashflow_date" />
                                        </div>
